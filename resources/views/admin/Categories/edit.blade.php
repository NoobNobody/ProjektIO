        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="py-2 sm:col-span-6">
                    ...
                    <div><img class="w-32 h-32" src="{{ Storage::url($category->image) }}">
                    </div>
                    <div class="mt-1">
                    ...
                    @error('image')
                        <div class="text-sm text-red-400">{{ 'Zdjęcie kategorii jest wymagane!' }}</div>
                    @enderror
                </div>
            </div>
            <div class="py-2 justify-center items-center">
                ...
                @error('description')
                    <div class="text-sm text-red-400">{{ 'Opis kategorii jest wymagany!' }}</div>
                @enderror
            </div>
